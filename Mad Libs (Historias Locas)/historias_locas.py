...
madlib = f'¡Programanr es tan {adj}! Siempre me emociona porque me encanta {verbo1} problemas. ¡Aprender a {verbo2} con freeCodeCamp y alcanza tus {sustantivo_plural}!'
